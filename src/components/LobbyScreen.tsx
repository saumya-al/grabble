...
const LobbyScreen: React.FC<LobbyScreenProps> = ({
    ...
    if (mode === 'menu') {
        return (
            <div className="modal show">
                <div className="modal-content lobby-screen" style={{ position: 'relative' }}>
                    {/* Theme toggle button */}
                    <button
                        className="theme-toggle-btn-lobby"
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.transform = 'rotate(15deg)'; }}
